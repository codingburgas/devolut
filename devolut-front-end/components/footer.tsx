...
const Footer = () => {
  const ShopIcon = () => (
    <Icon viewBox="0 0 16 16" fill="currentcolor">
    ...
    <Box marginTop={'12'} marginBottom={'5'}>
      <Center>
        <ButtonGroup spacing="2">
          <Tooltip label="Shop" bg={'black'} textColor={'white'}>
            <IconButton
              bg={'whiteAlpha.200'}
              aria-label="Shop"
              icon={<ShopIcon />}
          ...
          <Tooltip label="Discord" bg={'black'} textColor={'white'}>
            <IconButton
              bg={'whiteAlpha.200'}
              aria-label="Discord"
              icon={<DiscordIcon />}
          ...
          <Tooltip label="YouTube" bg={'black'} textColor={'white'}>
            <IconButton
              bg={'whiteAlpha.200'}
              aria-label="YouTube"
              icon={<YouTubeIcon />}
